...
<body>
    ...
    <div class="hero-page contact">
        ...
        <div class="two-col context" style="position: relative; left: 5px !important; width: 500px;" >
            <h3>Contact</h3>
            <h1>Brgy Sta Cruz</h1>
            <a href="#!" class="button" style="vertical-align: middle"><span class="icon" style="vertical-align: middle; margin-right: 10px">
